...
After installing Games::Lacuna::Task you need to create a configuration file 
called config.yml in the lacuna directory (Defaults to ~/.lacuna).
...
C<lacuna_task> script. Configure cron to run these tasks regularly. Eg.g

    # Run default tasks every hour
    0   *    *    *    *     lacuna_task
...
Fetch from github.com
 ...
 git://github.com/maros/Games-Lacuna-Task.git
