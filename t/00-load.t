...
use_ok( 'Games::Lacuna::Task::Action::Fissure' );
use_ok( 'Games::Lacuna::Task::Action::FissureLocal' );
use_ok( 'Games::Lacuna::Task::Action::FissureRemote' );
use_ok( 'Games::Lacuna::Task::Action::Mining' );
use_ok( 'Games::Lacuna::Task::Action::Mission' );
use_ok( 'Games::Lacuna::Task::Action::OptimizeOre' );
...
use_ok( 'Games::Lacuna::Task::Action::ShipBuild' );
use_ok( 'Games::Lacuna::Task::Action::ShipDestroyed' );
use_ok( 'Games::Lacuna::Task::Action::ShipDispatch' );
use_ok( 'Games::Lacuna::Task::Action::ShipUpdate' );
use_ok( 'Games::Lacuna::Task::Action::ShipSend' );
use_ok( 'Games::Lacuna::Task::Action::Spy' );
use_ok( 'Games::Lacuna::Task::Action::SpyAssign' );
use_ok( 'Games::Lacuna::Task::Action::SpyFetch' );
use_ok( 'Games::Lacuna::Task::Action::SpySend' );
use_ok( 'Games::Lacuna::Task::Action::SpyTraining' );
...
use_ok( 'Games::Lacuna::Task::Action::StationPlanPush' );
use_ok( 'Games::Lacuna::Task::Action::StationUpgrade' );
...
use_ok( 'Games::Lacuna::Task::Action::UpgradePlatform' );
...
use_ok( 'Games::Lacuna::Task::Action::VrbanskUpgrade' );
use_ok( 'Games::Lacuna::Task::Action::WasteChain' );
...
use_ok( 'Games::Lacuna::Task::Report::Alerts' );
use_ok( 'Games::Lacuna::Task::Report::Battle' );
use_ok( 'Games::Lacuna::Task::Report::BuildQueue' );
...
use_ok( 'Games::Lacuna::Task::Report::Vrbansk' );
use_ok( 'Games::Lacuna::Task::Role::Actions' );
use_ok( 'Games::Lacuna::Task::Role::BestShips' );
...
use_ok( 'Games::Lacuna::Task::Role::Inbox' );
